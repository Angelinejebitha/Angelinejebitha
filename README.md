...
- Developed an interactive dashboard to analyze attendance data of 80+ employees over a 3-month period
- Created DAX measures for Attendance Rate, WFH Share, and Sick Leave Rate
...
- Created an interactive Power BI dashboard to analyze financial data from Mar 2025 – Feb 2026
- Cleaned and transformed raw data using Power Query, handling missing values and inconsistencies
...
**🔗 Connect with me**
- LinkedIn: www.linkedin.com/in/angelinejebitha
